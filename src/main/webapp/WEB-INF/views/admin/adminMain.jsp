				...
				<div class="col-md-6 grid-margin stretch-card">
					<div class="card tale-bg">
						<div class="card-people mt-auto">
							<img src="resources/admin/images/dashboard/people.svg"
								alt="people">
					...
					<div class="card">
						<div class="card-body">
							...
							<p class="font-weight-500">The total number of sessions
								within the date range. It is the period time a user is actively
							...
							<div class="list-wrapper pt-2">
								<ul
									...
									<li>
										<div class="form-check form-check-flat">
											<label class="form-check-label"> <input
												class="checkbox" type="checkbox"> Meeting with Urban
												Team
											</label>
									...
									<li class="completed">
										<div class="form-check form-check-flat">
											<label class="form-check-label"> <input
												class="checkbox" type="checkbox" checked> Duplicate
												a project for new customer
											</label>
										</div> <i class="remove ti-close"></i>
									</li>
									<li>
									...
									<li class="completed">
										<div class="form-check form-check-flat">
											<label class="form-check-label"> <input
												class="checkbox" type="checkbox" checked> Follow up
												of team zilla
											</label>
										</div> <i class="remove ti-close"></i>
									</li>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-8 text-white">
											<h3>34040</h3>
											<p class="text-white font-weight-500 mb-0">The total
												number of sessions within the date range.It is calculated as
												the sum .</p>
										</div>
					...
					<div class="card">
						<div class="card-body">
							...
							<ul class="icon-data-list">
								<li>
									<div class="d-flex">
										<img src="resources/admin/images/faces/face1.jpg" alt="user">
										<div>
								...
								<li>
									<div class="d-flex">
										<img src="resources/admin/images/faces/face2.jpg" alt="user">
										<div>
								...
								<li>
									<div class="d-flex">
										<img src="resources/admin/images/faces/face3.jpg" alt="user">
										<div>
								...
								<li>
									<div class="d-flex">
										<img src="resources/admin/images/faces/face4.jpg" alt="user">
										<div>
								...
								<li>
									<div class="d-flex">
										<img src="resources/admin/images/faces/face5.jpg" alt="user">
										<div>
